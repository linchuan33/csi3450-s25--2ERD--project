    ...
    <form action="edit_process.php" method="post" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="vehicle_id" name="vehicle_id" required>
                ...
                <option value="<?php echo $vehicle['VEHICLE_ID']; ?>" <?php if ($vehicle['VEHICLE_ID'] == $log['VEHICLE_ID']) echo 'selected'; ?>><?php echo $vehicle['VEHICLE_INFO']; ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="maintenance_description" name="maintenance_description" rows="3" required><?php echo $log['MAINTENANCE_DESCRIPTION']; ?></textarea>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="initial_log_entry_date" name="initial_log_entry_date" value="<?php echo $log['INITIAL_LOG_ENTRY_DATE']; ?>" required>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="mechanic_id" name="mechanic_id">
                ...
                <option value="<?php echo $mechanic['MECHANIC_ID']; ?>" data-inspection="<?php echo $mechanic['INSPECTION_AUTHORIZED'] ? '1' : '0'; ?>" <?php if ($mechanic['MECHANIC_ID'] == $log['MECHANIC_ID']) echo 'selected'; ?>>
        ...
        <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" id="is_completed" name="is_completed" <?php if ($log['STATUS'] == 'Completed') echo 'checked'; ?>>
            <label class="form-check-label" for="is_completed">Maintenance is completed</label>
        </div>
        
        <div id="completion_fields" style="display: <?php echo $log['STATUS'] == 'Completed' ? 'block' : 'none'; ?>;">
            <div class="mb-3">
                <label for="completion_date" class="form-label">Completion Date</label>
                <input type="date" class="form-control" id="completion_date" name="completion_date" value="<?php echo $log['COMPLETION_DATE']; ?>">
            </div>
            
            <div class="mb-3">
                <label for="inspection_mechanic_id" class="form-label">Inspection Mechanic</label>
                <select class="form-select" id="inspection_mechanic_id" name="inspection_mechanic_id">
                    <option value="">Select Inspection Mechanic</option>
                    <?php foreach ($mechanics as $mechanic): ?>
                        <?php if ($mechanic['INSPECTION_AUTHORIZED']): ?>
                        <option value="<?php echo $mechanic['MECHANIC_ID']; ?>" <?php if ($mechanic['MECHANIC_ID'] == $log['INSPECTION_MECHANIC_ID']) echo 'selected'; ?>>
